...
namespace eg {
	...
	public:
		...
		virtual Object *object_requestPointer(GlbRtrn &rtrn, Object const *const object0, FunctionType const type0, Param<Scope_Param_e> param) const = 0;

		virtual void add_egFunctionObject(Object *const nobject) = 0;
		virtual void remove_egFunctionObject(Object *const nobject) = 0;
		virtual std::function<void(Object *const nobject)> object_get_unbindFunction(Object const *const nobject) = 0;
	};
}