...
namespace eg {
	...
	public:
		...
		virtual bool object_writeData(GlbRtrn &rtrn, Object const *const object, DataReference &dataReferece, Param<WriteData_Param_e> const param, Param<Scope_Param_e> const scope_param) const = 0;
		virtual bool object_writeData(GlbRtrn &rtrn, Object const *const object, DataReferenceSet &dataReferenceSet, Param<WriteData_Param_e> const param, Param<Scope_Param_e> const scope_param) const = 0;

		virtual Object *object_requestPointer(GlbRtrn &rtrn, Object const *const requester, eg::Descriptor<> desc, Param<Scope_Param_e> param) const = 0;
